...
(function () {
  ...
  var GROUPS = [
    { id: 'photography', label: 'Photography', note: 'light, and whatever it lands on', n: 10 },
    { id: 'artwork',     label: 'Artwork',     note: 'graphite, ink and gouache',       n: 4  },
    { id: 'cooking',     label: 'Cooking',     note: 'mostly dinner, occasionally dessert', n: 6 }
  ];
