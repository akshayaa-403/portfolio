...
/* ==========================================================================
   ...
   With ?edit=1 the frames are unhidden so they can be dragged without holding
   a hover. P dumps the offsets as ready-to-paste CSS; those values become
   --hx/--hy on .rm__hover--bare. D belongs to the hero editor above.
   ========================================================================== */
(function () {
  'use strict';
  ...
  function init() {
    ...
    document.addEventListener('keydown', function (e) {
      // P, not D: the hero editor above already owns D and writes the
  ...
  // `load`, not onReady: this file is injected dynamically, so it can execute
  // before js/script.js (defer) has rendered the cards these frames live in.
  // By load every deferred script has run.
